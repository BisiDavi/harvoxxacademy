      ...
      <div class="row px-3 py-3">
        <div class="who-are-we">
          ...
          <p>
            ...
            education with sports along with a special focus on football development. The academy is designed to help
            aspiring players hone their football skills, place them in the limelight, and facilitate their discovery and
            recruitment
        ...
        <div class="container-fluid d-flex">
          <div class="core-values vision d-flex mr-3 col-md-6 col-sm-6 col-xs-12">
            ...
            <div class="m-auto">
              <h1>Vision</h1>
              <p>
                To have sports industry that is profitable, well-organized and competitive on international stage and
            ...
            <ul class="col-md-8 col-sm-8 col-xs-12">
              <div class="row">
                <div class="col">
                  ...
                  We have the resolve to show commitment in all we set out to do; we are committed to our goals, services
              ...
              <div class="row">
                <div class="col">
                  ...
                  We believe in efficiency and product that can be achieved from working together, identifying each
